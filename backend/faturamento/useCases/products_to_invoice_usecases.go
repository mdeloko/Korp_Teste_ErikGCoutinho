...
func (ptiu *ProductsToInvoiceUseCases) GetProductsToInvoiceByInvoiceId(id int) ([]models.Product, error) {
	return ptiu.repository.GetProductsToInvoiceByInvoiceId(id)
}
...
func (ptiu *ProductsToInvoiceUseCases) RemoveProductFromInvoice(invoice_id int, product_id string) error {
	return ptiu.repository.RemoveProductFromInvoice(invoice_id, product_id)
}
